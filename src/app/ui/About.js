  ...
  return (
    <div className="h-full w-full flex justify-center"
      style={ {
        ...
        <div className="my-[120px] mx-[16px] text-neutral-content card bg-base-100 shadow-lg h-2/3">
          <div className="max-w-md card-body">
            ...
            <p className="py-6 font-medium mb-0">Lambeth and Lambeth adjacent cakes inspired by birdbaths, Victorian houses, stained glass windows, Petri dishes, flower gardens and more. Eccentricity and maximalism encouraged, simplicity sometimes accepted.</p>
            <a href="mailto:houseflyvictuals@gmail.com">houseflyvictuals@gmail.com</a>
          </div>
        </div>
    </div>
  )
